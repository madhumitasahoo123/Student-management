...
public class AddStudent extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean b = service.addService.addstudentpage(jTextField2.getText(),jTextField3.getText(),jTextField4.getText(),jTextField5.getText(),jTextField6.getText());
         if(b){
             JOptionPane.showMessageDialog(this,"Add Suceesfully");
         }
         else{
