...
public class Signup extends javax.swing.JFrame {
   ...
   boolean b = service.signUpservice.insertUser(jTextField1.getText(), jTextField2.getText(),jTextField3.getText(),jPasswordField1.getText());
       if(b){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        new ForgotPassword().setVisible(rootPaneCheckingEnabled);
        dispose();
